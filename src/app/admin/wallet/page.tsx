            ...
            <div className="min-h-screen bg-zayko-900 pb-12">
                ...
                <div className="bg-zayko-800 border-b border-zayko-700 px-6 py-4 sticky top-0 z-20">
                    <div className="max-w-7xl mx-auto flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-xl font-display font-bold text-white">💰 Canteen Wallet</h1>
                        </div>
                        <button
                            onClick={exportCSV}
                            className="text-sm px-4 py-2 bg-zayko-700 hover:bg-zayko-600 text-zayko-200 rounded-lg transition-colors border border-zayko-600"
                        >
                            📥 Export CSV
                        </button>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 mt-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Total Balance Card (Glassmorphism + Gradient) */}
                        ...
                        <div className="bg-zayko-800/50 border border-zayko-700 rounded-3xl p-6 backdrop-blur-md">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="p-3 bg-blue-500/20 text-blue-400 rounded-xl">⏳</div>
                    ...
                    <div className="bg-zayko-800/50 border border-zayko-700 rounded-3xl p-6 backdrop-blur-md">
                        <h3 className="text-white font-display font-bold text-lg mb-6">📝 Recent Transactions</h3>
